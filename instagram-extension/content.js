...
(function() {
                ...
                <div class="form-group">
                    ...
                    <div class="terminal" id="log-terminal">
                        <div class="log-entry">
                            ...
                            <span class="log-info">Painel Extensão v1.5 pronto. Clique no ícone do Instagram para abrir/fechar.</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    async function startScanningBackgroundRelations() {
        ...
        if (!loggedUserId) {
            log('Erro: Não foi possível obter o seu ID da conta logada. Certifique-se de que está logado no Instagram.', 'error');
            return;
        }
        ...
        try {
            ...
            log('Passo 3/3: Cruzando os dados carregados...', 'info');
    ...
    async function executeStep() {
        ...
        if (window.location.pathname !== lastVisitedPath) {
            ...
            log(`Navegação detectada para: ${lastVisitedPath}. Adaptando elementos da página.`, 'info');
        }
